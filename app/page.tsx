...
const ShowcaseSection = dynamic(() => import("../components/ShowcaseSection"), {
  loading: () => <div className="min-h-[400px] bg-[#F2F5FC]" />,
});
const Features = dynamic(() => import("../components/Features"), {
  loading: () => <div className="min-h-[200px] bg-[#F2F5FC]" />,
});
...
export default function HomePage() {
  ...
  const servicesHighlight = React.useMemo(
    () => resolveServicesHighlight(dictionary),
    [dictionary]
  );
