...
useLayoutEffect(() => {
  ...
  return (
    <section className="bg-[#F2F5FC] px-4 pt-2 pb-12 sm:pt-6 sm:pb-16">
      <div className="mx-auto flex w-full max-w-[1145px] flex-col">
        <div className="flex flex-col gap-8 md:flex-row md:items-start md:justify-between relative z-0 pb-24 sm:pb-32 lg:pb-40">
          <Reveal className="relative mt-[clamp(2.5rem,7vw,6rem)] max-w-2xl space-y-6">
          ...
          {hasPartnersHighlight && (
            <Reveal delay={160} className="relative max-w-sm self-start text-sm font-medium text-[#0A304E]">
