...
export default function ContactForm({ variant = "default", bookingSummary = null }: ContactFormProps) {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    if (isOverlay) {
      ...
      // Ajouter le créneau de réservation s'il existe
      if (bookingSummary) {
        options.bookingSummary = bookingSummary;
      }
    } else {
